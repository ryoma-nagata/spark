...
DOTNET_SPARK_RELEASE=https://github.com/dotnet/spark/releases/download/v1.0.0/Microsoft.Spark.Worker.netcoreapp3.1.linux-x64-1.0.0.tar.gz
...
set +e
/bin/bash $DBFS_INSTALLATION_ROOT/install-worker.sh azure $DOTNET_SPARK_RELEASE $DOTNET_SPARK_WORKER_INSTALLATION_PATH
